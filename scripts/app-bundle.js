...
define('app',["require", "exports", 'aurelia-i18n', 'aurelia-event-aggregator', 'aurelia-framework'], function (require, exports, aurelia_i18n_1, aurelia_event_aggregator_1, aurelia_framework_1) {
    "use strict";
    var App = (function () {
        function App(i18n, element, ea) {
            this.i18n = i18n;
        ...
        App.prototype.updateTranslations = function () {
            console.log("updating translation");
            this.i18n.updateTranslations(this.element);
        };
        App.prototype.setLocale = function (id) {
            this.i18n.setLocale(id);
        };
        App.prototype.getLocale = function (id) {
            return this.i18n.getLocale();
        };
        App = __decorate([
            aurelia_framework_1.autoinject, 
            __metadata('design:paramtypes', [aurelia_i18n_1.I18N, Element, aurelia_event_aggregator_1.EventAggregator])
        ], App);
        return App;
    }());
    exports.App = App;
...
define('text!app.html', ['module'], function(module) { module.exports = "<template>\n  <a click.delegate=\"setLocale('fr')\">fr</a>|<a click.delegate=\"setLocale('en')\">en</a>\n  <h1 t=\"message\"></h1>\n</template>\n"; });
